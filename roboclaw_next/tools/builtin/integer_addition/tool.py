"""MCP contract for the standalone integer addition program."""
...
def register_integer_addition(mcp: FastMCP) -> None:
    """Register the integer addition Tool on an MCP server."""
    ...
    async def add_integers(
        ...
        program_path = Path(__file__).with_name("program.py")
